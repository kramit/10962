# But imagine if we retrieved more than one object in our command.
# We might need a nested ForEach to enumerate those.
...
function Get-CorpCompDiskInfo {
    ...
    foreach ($computer in $computername) {
        ...
        foreach ($disk in $disks) {
            Write "Disk $($disk.deviceid) on $computer has $($disk.freespace / $disk.size * 100 -as [int])% free"
        }
    }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUnXbKln7CL9yC6JkQlkVkaWJ8
# DLGgghhlMIIEwzCCA6ugAwIBAgITMwAAAMWWQGBL9N6uLgAAAAAAxTANBgkqhkiG
...
# gjcCARUwIwYJKoZIhvcNAQkEMRYEFCZcgSB+UzaMZhbcFxwcC+mqFU9/MF4GCisG
...
# SIb3DQEBAQUABIIBAM/ZqaVrJPL7+eNU0GO4cWyOU04poL4eGFo1KMYY+4CQVSe0
# YnoSPHzELxUnDWDRgu0uTJ9IG/nuBxj+lS9dUUutGX+CU/ncvMY/0HOIQE1jOT6F
# ILPF8OgC0zVMJCinf+vyiD+Cw/UHRr+YAsHykkNG4hWWO2KxH5ptovETlt+CGm6I
# 1TZ6FOq4SyVkwYiWfbZpRCtgiH2NlXUSEDpeHxo/t7N+kCM9eaAKlnK4q5RABIY7
# rByUnJG7+IblIMQ4puXKe0M7uyN7IpbTGeP9kzRyjxxgqEYhzGTEKHdOkBS1AqGd
# rPNwNwy6ClmZw4iSpXmEHiIngsch+SpKS0dCFmShggIoMIICJAYJKoZIhvcNAQkG
...
# BBTUYNXwl5OudVJvGCQlrJ4bdSZ+KzANBgkqhkiG9w0BAQUFAASCAQAYnVuF1zM8
# PLw6nVkmz9SZX5g4MZikyYA8V1uTA0o5Rg2O18Dn6/oenJoK5YlyD+Pku2OSvP1w
# jNI6pdnSSlRIXw/m7ohuY+5+xRCGtEHbdIZVIz8GNmnpuXTgv0Btk4IZZjcATtKC
# oBzmbTobvtqQoZF00jTQ1mCfhYXE8gYT4fzrxsPuOapTVWLpEtHIp+b3OGvG+MdY
# ncAP6zs+sdtk7M2va8tx8nR3c1s2GWhF50v3t9iv9BPqEy8OSXHO3d2JvgjfVp7H
# 10Ju9EyEsXJ9k54XakxwlidNc+GFng1LY6mKTe0A1BoWa8B801osWrN6zPE2XY6P
# rbnEBIvl0Ljn
