# Notice that the variable names do not matter
# It is common to select plural nouns for variables that contain collections
# and singular nouns to for variables that contain one object
# But that is a convention, not a rule

function Get-CorpCompDiskInfo {
    [CmdletBinding()]
    Param(
    ...
    foreach ($computer in $computername) {
        ...
        $rocks = Get-CimInstance -ClassName Win32_LogicalDisk -ComputerName $computer -Filter "DriveType=3"
        
        foreach ($tablet in $rocks) {
            Write "Disk $($tablet.deviceid) on $computer has $($tablet.freespace / $tablet.size * 100 -as [int])% free"
        }
    }
}

# Press F5 to run and test this example function
Get-CorpCompDiskInfo -ComputerName localhost

# SIG # Begin signature block
# MIIatQYJKoZIhvcNAQcCoIIapjCCGqICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUOoXF1ugIZl2CuAr/zSzA92+A
# UaygghV6MIIEuzCCA6OgAwIBAgITMwAAAFrtL/TkIJk/OgAAAAAAWjANBgkqhkiG
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSGz/7X2wfm4N4q
# rTREjpaqGTlrNzBeBgorBgEEAYI3AgEMMVAwTqAmgCQATQBpAGMAcgBvAHMAbwBm
# AHQAIABMAGUAYQByAG4AaQBuAGehJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
# L2xlYXJuaW5nIDANBgkqhkiG9w0BAQEFAASCAQBAMVHrRm/yqY0z3MWI+4puOE/u
# e2GaX/rPefP+c3IJIRPtik9XD0BBstlO7xr+6j5uJNJNpPkKlyR9T72owGuw/vJ2
# 3uPlanh7B2+gxCJdV4ZjKq7UBZ2FtpU4TesTppP7F8DR/kfjDprLGLnnrxDumO3G
# wOEaly1xvuNcivlkLmwW/HV2Z66oogHv+IA4knjTvBv1y2YaGC36IcCvRZ3CGbR3
# df/sCsWTC3GgfKuCO5Wqg9wKAbuH9541IUKiguKy9PjtyJBFV+hBX+jKTl7Vjb+h
# +DIOp9XocWxyREiprlAiOJXJ9KKKZw1g/+RloZZQkJ2iw+9HTFvYBRi8fTgeoYIC
...
# WjAjBgkqhkiG9w0BCQQxFgQU+/AISLQggevJCYIrQoRBpssO5xUwDQYJKoZIhvcN
# AQEFBQAEggEAcRmNPMPrW1TQSNw8Kw0tNXdeNR9ILfNaEv2w+zDN/FwvON6ztqSx
# 0dWYnLX0Dhzq3/F24bMHCIcrIo/34C5Q5W0qNaSoiPfMegkZjHNh0g2OCB80oJmz
# a7ABtfmr50ZeqGxQ1bSpu6sghQCiV8KzPdZZgFR/+cQOLIwRKWHq1gW7Tr3awaHV
# Gq8+eoKpmryP2PE0YplyeqqY3QNgEBWaaiNG7EfconcgvQADoSbobuNrdGtMG7u1
# MaYUKsp1iOc63/tfJUi4ZVsWchXpSpJFc1kagDXPIUv2eTWiylPzXK1FNesagazR
# nx0acRkt1BGxGBYkCrOevbzKosI+emhvVw==
