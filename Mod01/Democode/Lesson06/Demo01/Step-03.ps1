...
# we can get help for the command as if it were a native shell command.

# Highlight and run only this line:
Help Get-CorpCompSysInfo

# Highlight and run only this line:
Help Get-CorpCompSysInfo -Full

# Highlight and run only this line:
Help Get-CorpCompSysInfo -ShowWindow
# SIG # Begin signature block
# MIIatQYJKoZIhvcNAQcCoIIapjCCGqICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUMxut6zzCKnh3QcJvyNST7W+x
# JAygghV6MIIEuzCCA6OgAwIBAgITMwAAAFrtL/TkIJk/OgAAAAAAWjANBgkqhkiG
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBTM5y9RfEORc6Cy
# HKrq+LOcvia22TBeBgorBgEEAYI3AgEMMVAwTqAmgCQATQBpAGMAcgBvAHMAbwBm
# AHQAIABMAGUAYQByAG4AaQBuAGehJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
# L2xlYXJuaW5nIDANBgkqhkiG9w0BAQEFAASCAQB7Wz8w8Z7h3P1O3Ek8jogudQ9D
# BMIelpgWvgqkOkJVSRK+LAmIVordOpx00OYtxt8TZXf4jC0MRzc+eUCuzWrIogfu
# nfno0hifiVtYBy1YOcJj5pfQRa2/4/pgwjoGMnt6EMH+hD2MBtrtPjWY2qTvDwj1
# 8XKydfx59hLosnv20mXCwpyUW4XmPBGPfozatoqtMD8e9MqYB4nxB7b0YBcoRZuo
# jMMtuvCKZvyeeahyywuCdisW3dFB2aEwmqNJ9err4RklPK4Tz5C9I8qTTdD41rZX
# xKoh5Sty1MR2igUjXESpfBbjl4DTV8GovL6/HnKLJyZowgB2O9UT36MSE1BJoYIC
...
# hvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMTQxMDI3MDg0MzI5
# WjAjBgkqhkiG9w0BCQQxFgQU8WS7iLIR8dSnZPozcpZnt8UgJD0wDQYJKoZIhvcN
# AQEFBQAEggEALwbApJlFPxFR/WmcciZ+UyO7UA6ayfv1SMkeA4Rn/FGw274r3Sgq
# sRJmiz/xxuhSzIOTuiDn7bCNtS5n3/micbPdonVdURl4sY9FtxBQxYU0m1OaKliL
# ZuvzafvCuUft6D1RC3L+MTFnT31wzGLxcA8gYwerp97w4GB2/zYnmmF0MIC94+Dh
# zl8KPwxoyTPs2kh6ZJgJcYdNksyKrlBrg69DbxornvxSNoulzhNVA/VYXqDxRbsL
# U3lDzgVR7u0XFsc7GDDAA9jBj9gLXAIvKLC5zFwN6H0FH5tSF8l81hFxGPZ9m+uF
# iGS3BuPmaUkDpGaWh5zBszqW57I4SlzY7w==
