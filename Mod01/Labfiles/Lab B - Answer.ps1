Function Get-CorpOSInfo {
    ...
    $datetime = get-date
    Write-Verbose "Connecting to $computername at $datetime"
    Write-Debug "debug stuff"
    
    Get-CimInstance -ComputerName $computername -ClassName Win32_OperatingSystem -Verbose

}
# SIG # Begin signature block
# MIIatQYJKoZIhvcNAQcCoIIapjCCGqICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUXQ5AxsBAZRcgc7Tr0Boey7+u
# PfigghV6MIIEuzCCA6OgAwIBAgITMwAAAFrtL/TkIJk/OgAAAAAAWjANBgkqhkiG
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBT7Fi1m2nTiVdtK
# t4Nz1skmHHw2djBeBgorBgEEAYI3AgEMMVAwTqAmgCQATQBpAGMAcgBvAHMAbwBm
# AHQAIABMAGUAYQByAG4AaQBuAGehJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
# L2xlYXJuaW5nIDANBgkqhkiG9w0BAQEFAASCAQAa7Tthku53Cxd0ejdovwagubGu
# wO1ggOUWfGrwivG+UOi4aglNLmnXdBnmem5fS74AXdeSUe99gPb8/ww2rA8GZHD/
# +gAaDeyiwhT9PToKNaXwpOfpJtxmR5nGZCzq+NqM8zku9FA8GnQr7d1+qr3SQ1X8
# UO3cAT9RpHPvtc0FXwgcpgkYGPuFIMGgpCC2AFQJjSaxzWadf1XYh534o2hlM6XA
# BnXrq2sEAdZ/JmJ7S0W3Rp5DddbDudwnazNNTHj5ohENq9HVwWwuRzDaARJnfuPn
# r8rXv7hCt2guyhHXw+HlGJLj+UNBJnUWgzhCCPPdaOaIgVsWC/tcfEpjCGV5oYIC
...
# hvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMTQxMDI3MDg0MzMx
# WjAjBgkqhkiG9w0BCQQxFgQUPuf9adONIQyhRerhb0m3K75u+NgwDQYJKoZIhvcN
# AQEFBQAEggEAXU0XYPNX2kWHLxv0lNgukZOapNMIp2tXvbm5IYkVbfoQQzFuBWRV
# Scj86gQqSndoyIA9x/3qRxI9DI2faBiGVZ3FLkFsa6XKJvMG/ZaqWfIzWiaxyN4K
# 9cmWAg4InQCIiY7bfPVO6+lxUHduhXbmISVWCGaWpQuXj4MlwNnJ2HNEO8ThrQlS
# bc800bz/kfxI/uHxA5mDh14qM+lsi1oIBb8jGuFXK3QE6ax4M7lWNMP8vLPVSGfO
# e9daKp3eq1klYo4pTs4RZfaj/6aS0MRam6YpR6xt2m9v0rMWVo55uW8nqsb9SXdU
# Ws3kBIHUZb7AmpISc+naaSJr3jpS/tXxAA==
