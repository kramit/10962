...
Function Set-CorpServicePassword {
<#
.SYNOPSIS
...
"YY" can be 1 or 2 digits.
.EXAMPLE
 Get-Content names.txt | Set-CorpServicePassword -ServiceName "BITS" -NewPassword "Pa$$w0rd"
This example assumes that names.txt includes one computer name per
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUv1rZ6AgmloBr/hhbyKgnxwxX
# umegghhlMIIEwzCCA6ugAwIBAgITMwAAAMZ4gDYBdRppcgAAAAAAxjANBgkqhkiG
...
# gjcCARUwIwYJKoZIhvcNAQkEMRYEFAhOSB/rfYSkr1kd8yNQjK6TLwexMF4GCisG
...
# SIb3DQEBAQUABIIBACceD4Oytn5LIPI166EDJ7SxeH22dmTXDy5NXdQqUvag9MW3
# KOq+eFDHfr7WoBYvngeS7M4nlHltYyoVj4zprBSH8mvOsWCqeu5TFD9BDMubH0hL
# EHpwOCCQAxPkWZC3TT1Scv707Skw9aNYcNPetcyAXTTbN3fbqPcXnLXZKdCAY1gb
# WVZrWLIZk/d5gskCzLoWksST4pCJfsDSq2vo16n1SIi7XGP5AHc1gFAF99zkHS/e
# ZlzHCjZCrAUxwVd5olUs/UfqE4bhkm5qOX9aTeaQGHtJzi93cEWLq6FXxP/lVooE
# fG7ax6mZOg9mZHgaGwstg7Sz0v9HMYYsHkNRMUWhggIoMIICJAYJKoZIhvcNAQkG
...
# BBS9gR/jOPzZZUWfnslZ28OGuIcvMTANBgkqhkiG9w0BAQUFAASCAQBf15XNa7w9
# rqP6NuXrzX+NfZIHg8HpNsJ6+uf1A3YqPthIZb1+CK6Itvu5wSDEUZomJu6ICkoQ
# 8b0LF7h2E9Q/j4huSlGoYy8F+mrD5kz3tmTnq/xiVlrNJpYHgBDsqQrhoBI0oZ53
# eZ2HrQJ0a2WzKdFjNMb9Pqw2jxmGbhgZBbjCfMi2yPJpLJZ1TQHgi2XxOfG/VOK2
# dHfWNW000ODCnKatxjWyNgogC5BRmdU0H9NQ0JxwD5Qr3rLJo2jI3nsiMp/Q5yL1
# Fp6Cp/S3mng99PTNpGFR69I6MD0AFoJDIqAcHNTSYv46n41bgsZwHwUg1Sq6kFLc
# I5YDUw91Z78S
