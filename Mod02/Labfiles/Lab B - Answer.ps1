...
# create a new web site site01 (port 8081) on LON-SVR1
#######################################################
 ...
 $newSite = @"
    { "name":"$siteName",
      ...
      [
        {
            "protocol":"http",
            "binding_information": "*:$($portNumber):",
            "ip_address":"*",
            "port":"$portNumber"
        }
      ]
...
"@;
 ...
 $iisAdminApiNewSite = Invoke-RestMethod -Uri "$apiUrl/api/webserver/websites" `
					 -UseDefaultCredentials `
					 -Headers $headers `
					 -Method Post `
					 -ContentType "application/json" `
 ...
 $iisAdminApiNewSite | ConvertTo-Json
...
# delete the newly created web site site01 on LON-SVR1
#######################################################
...
$iisAdminApiDeleteSite = Invoke-WebRequest -Uri "$apiUrl/api/webserver/websites/$($webSiteid)" `
					   -UseDefaultCredentials `
					   -Headers $headers `
                                	   -Method Delete 

$iisAdminApiDeleteSite | ConvertTo-Json
# SIG # Begin signature block
# MIIdpQYJKoZIhvcNAQcCoIIdljCCHZICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU0g8u6VDCqMAoV2y4Ob/8uCIw
# Eq+gghhlMIIEwzCCA6ugAwIBAgITMwAAAMhHIp2jDcrAWAAAAAAAyDANBgkqhkiG
...
# gjcCARUwIwYJKoZIhvcNAQkEMRYEFKv6uAPEZSFOB1I3t9LCg5QfAVtfMF4GCisG
...
# SIb3DQEBAQUABIIBAH+bBROn4lH81KVNFvxxmIfNvZvEpNeMzHiPo57Y0Hy5ndTO
# 0iOHG4M0wV9ojkRooPuDnVtRYwvftQ/VkUANg9EfImtbKBIWegrPt4Qj4G7XzE1A
# d2PgKAZ+EwCci9CXm18KBNOAaUIpb8SOi5HGSE72FoHdO1xWdX5X7KOLGMvcbYox
# pjpIbs+V37KdgjGYth4dpb8Kb93yBz78pTZB0Adcs8apGAqzolZOQkirjGO8gRaT
# cztROtgSjQypgafQo6HaEIVUytxF0BWhTUnhenplSoOPF63cMcWIo2H02GNXVNTO
# U1LuYwu3qerNDB5ZZ9EvF97Y3i5Dy1ys/LyDylmhggIoMIICJAYJKoZIhvcNAQkG
...
# AQcBMBwGCSqGSIb3DQEJBTEPFw0xNzA3MTgwNDE2MTVaMCMGCSqGSIb3DQEJBDEW
# BBQsKnbx+oHfgJZufZkSMnDXM1gzGzANBgkqhkiG9w0BAQUFAASCAQBfIraz+EBj
# 1+2PUqY8AB39I10VbpdUvOejTDH5/GiV0ukE3uLRiclJHaAPfElOjhvguZxcxzQJ
# yfhAfAK/gRLvj6a/Jg/T0ojE0wiqAAX9HSyg7MuTGHln55ln++k6zjI7dfjDfuDv
# exUVPlGYYMj5POgulbh43+iVJ3ZVTTLibN1B03A/qs1mtN7uI57PeaoF3y0BURuu
# 4mf7YFZwbd6zqfz/THiy7a4F2dsiSVArcJqUuGT4qla1+hbchr5fRkrFtuEBQ7jb
# JvDwkRdWzwNmp9KePuzbak5QjuRNH0rZAndtg7ye1Cg3872kcpxXSqYEgoRmaYNO
# YmuFIGrc+OyJ
