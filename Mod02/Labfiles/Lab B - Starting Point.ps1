...
$iisAdminApiResp1 = Invoke-WebRequest -Uri "$apiUrl/security/api-keys" -UseDefaultCredentials `
                                      -SessionVariable session 
$xsrfTokenHeader = $iisAdminApiResp1.Headers."XSRF-TOKEN"
    
$xsrfTokenHash = @{}
$xsrfTokenHash."XSRF-TOKEN" = $xsrfTokenHeader
$iisAdminApiResp2 = Invoke-WebRequest -Uri "$apiUrl/security/api-keys" -Headers $xsrfTokenHash -Method Post `
                                      -UseDefaultCredentials -ContentType "application/json" `
                                      -WebSession $session -Body '{"expires_on": ""}'
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUTZUHTqV/8S1HMjcw/wZOYRxC
# Zw2gghhlMIIEwzCCA6ugAwIBAgITMwAAAMzLuBPrXXItRQAAAAAAzDANBgkqhkiG
...
# gjcCARUwIwYJKoZIhvcNAQkEMRYEFCNi9jVZg2nkByT8OWwCPIy68idRMF4GCisG
...
# SIb3DQEBAQUABIIBAEj+JueqjnT587YfMr1hzbIXJyX4l3zYT1Z/Yj1e1MSPZCl1
# 9it3WNyN5NrCqSTm52uZ3kHiqWG5ctdgwy15axM8dejblDh5Hy4pxi5BsGqJ4PvE
# GVzvaobZ2dWGXJIk2X9VgAacA+2Fd8GBQZPSU17THt08n0Yewaj9moPyxgDJqoPK
# +pRLr/17Fz4+6MGhhdPyV8k8N4jWyfQhCVpk2R4M9POfRYgIuzWVGWMYx+X7Cdc3
# mYe0RCIYpUkfrNnjPIAvHtxhv0vs2stGwYZblaP2Eq0k3DUbgzz3J/XMoNf5Lp9q
# zudtirqQeZoRN7sOagIG57ZKROlKbhOwtft4QI6hggIoMIICJAYJKoZIhvcNAQkG
...
# BBScQjd0PCiG7Pjgz3VxjPA/nr/yZzANBgkqhkiG9w0BAQUFAASCAQBnHARt5pKY
# IXcA3Fsbv5CGGffDif7pumf6Bdqdrtl3EFEo5CowWZAn6X1Qt5O5drfNRYHCQb61
# ZHycD2+mwwzeFq4nWbkIkrAZIwtQz1u3MtDUrhrINla/0otkg7E0tgfr7PD771/N
# fNh5xd02SfMcvndUKNF1KWeCgIMooLy+j+qYkSOIhpLdHyxtF4A36R93TqW5x51M
# Xg7tQv+S8yxGYxtyHtKu6+1ZZLbrPzeB4xv1pAEwWA6DkR+Xxt4SNeQAkfQ4/zA3
# dF6Oijw9Ws1RZPoCQKawayj7JLoWzvjcXbYkJ413HfvrE1Bzos7nHeIrVp0K+TQC
# fRfQpANldRrT
