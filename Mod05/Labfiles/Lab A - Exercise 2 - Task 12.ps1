...
foreach ($computer in $xml.computers.computer) {
    ...
    $osinfo = Get-AdatumOSInfo -ComputerName $computer.name
    $computer.osversion = $osinfo.osversion
    $computer.spversion = [string]$osinfo.spversion
    $computer.biosserial = $osinfo.biosserial

    $disks = Get-AdatumDiskInfo -computername $computer.name
    ...
    foreach ($disk in $disks) {
        ...
        $disks_node.appendchild($disk_node)
    }

    $computer.appendchild($disks_node)

}

$xml.save('c:\inventory.xml')
# SIG # Begin signature block
# MIIatQYJKoZIhvcNAQcCoIIapjCCGqICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUe8Mi4zMZVlMLwupA/jvgqHXu
# D/KgghV6MIIEuzCCA6OgAwIBAgITMwAAAFrtL/TkIJk/OgAAAAAAWjANBgkqhkiG
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSvpcRR5vSYtiXW
# acvGr1SQwCjVrjBeBgorBgEEAYI3AgEMMVAwTqAmgCQATQBpAGMAcgBvAHMAbwBm
# AHQAIABMAGUAYQByAG4AaQBuAGehJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
# L2xlYXJuaW5nIDANBgkqhkiG9w0BAQEFAASCAQAHPG22wtfQ1s+xx4HcmBpEllE9
# /LkDtyz4dLR1I7TV6DinMpl6J5owR6alBilSaIlNTWaTS7rvXLmOKpD9QVPJ6kOz
# fRABkQjHPj9olMgj4Z9xUg1ATbdFLbE1sXclWL2rEaHhY+wxurmFNAZvTKn0vZWs
# RX0USl7vW3p24WWPJymkzdD8hnAZG2VrH+AEgk3BylPycb3DEYY7Eu0UHBlg9RzM
# CXEfr2rdeZVz4YogHj6WhBKIFPzKswKDenlErPHaskAQt6nudiQksjFShmB08K+2
# EmeNl5sOJJPsDkgjlcdTOmhWlE2BqktnD3sA/ShS6tP9fArRMWhhWDA3BvbKoYIC
...
# hvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMTQxMDI3MDg0MzQy
# WjAjBgkqhkiG9w0BCQQxFgQUJRfa/dtEWsMWdZQ8e+CoLCx44ZcwDQYJKoZIhvcN
# AQEFBQAEggEAR/DWr93G9JEzQksQGQk49b0D0mWiGsBeSTrax6N0wjQpv5U/7Aay
# RyjK5bsMZipnlys+7AYQ1ruuXm7grCq1Kwqs8RGe1n/HlU6iAS/cpUxJUb0NOn7j
# HBdz13upsMVh2miwkmQy0Ae8QgO3ONBXCKERAOh2QgK8NYdF5kOTlFGIFz3W6apt
# 2fEPxQX4QVUgV6EtWm0EsMegUWU3a48avAWGeYoh6NNCX6K2xj/+njs93jd8eiNL
# y44ijimAfTDlPU//uPSdUongT+uNNN/yadc+/vzWCGSkoCSO06ScMkdoSCD043sl
# NXGdagRJmoBz0GNCfoW1OIPGi2uy1lqjqA==
