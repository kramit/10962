Configuration AdatumStandards {
    ...
    Node $ComputerName {
        ...
        Script LogFolder {
            ...
            SetScript = { New-Item -Path C:\AdatumLogs -ItemType Directory }
        }
...
if (-not (Test-Path c:\DSC_MOFs)) {
    New-Item -Path C:\DSC_MOFs -ItemType Directory
}
AdatumStandards -ComputerName LON-SVR1 -OutputPath c:\DSC_MOFs

# SIG # Begin signature block
# MIIdpQYJKoZIhvcNAQcCoIIdljCCHZICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUoKyMOYeCnhJv07xNgZAOmUOp
# Do2gghhlMIIEwzCCA6ugAwIBAgITMwAAAMWWQGBL9N6uLgAAAAAAxTANBgkqhkiG
...
# gjcCARUwIwYJKoZIhvcNAQkEMRYEFGQl0ELkEzi8e8yWzs89gpuuEKECMF4GCisG
...
# SIb3DQEBAQUABIIBABHsWBNYFGBGy7/aMeUJwONar1OHKlQ0tgsHG689fpUMOXxD
# Cvq32NKIIhgrtWbxnV6nBY/u5ZIhnnJElwWltIwAsp+jXW6PBO3Es9ytTTpSPO4/
# Kgzet1BZbYoliMRXy287duhJ5H39oQvBLrO1hrfWh5nmy40e7VQgEVdPyFVXSlOu
# SjY5RBKcgDfa6+qxPbMAByJD+p5+ILQKwreajBP0r25WACEY7stQEvFBs81pr8+r
# eBLjqf0+zf2+vaNPK+3/5uI6M5oKy0wKSskRS0Wtno5i/nwFRUlUjdgsY+L9dxN1
# W1ZUfeWE5oFtZAqXuOir/eBLhhqfxFpxQttv1IKhggIoMIICJAYJKoZIhvcNAQkG
...
# BBSoBpwaB2D1c706v9Oe4Pzcwgc3XzANBgkqhkiG9w0BAQUFAASCAQAiE7FZt5Op
# u1A/iYxT7b3tLJoQnnnDuO4bdjeiI5GuHuLQXJuu0kJ5rTqAX2RX+x4QCDMHlvdd
# WOOoHJ2llNkj/dJCS/FAs0aP3i5sKmW6OSJtifojKbnWxZ3P6AVjOEOxQIkUV05/
# vxg9+ZoEPEmQpsAVupdsaukr9juyvIiXGz8JSeiYr4GrubPZArpespyUiW8MB4ds
# zZSzamzzPKwhkfVssgaWRyT0v+r2g8XRmPJu6ztCmDUF3mR4evIXBowRZYfE0/09
# 83CD+ASI0JYj0LO8x01lHogcnobp9YNlVTHFESRwNSZpt2YGO5rT/s85oRFcQUJx
# lTmPJBnoOkMH
