...
Invoke-Command -ComputerName LON-SVR1 -ScriptBlock { Get-WindowsFeature Windows-Server-Backup }

# Verify folder
Invoke-Command -ComputerName LON-SVR1 -ScriptBlock { Dir C:\ }

# Verify service
Invoke-Command -ComputerName LON-SVR1 -ScriptBlock { Get-Service BITS }
# SIG # Begin signature block
# MIIdpQYJKoZIhvcNAQcCoIIdljCCHZICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUI7u+RwX7rsihyrsPkhwdJjFF
# R4KgghhlMIIEwzCCA6ugAwIBAgITMwAAAMhHIp2jDcrAWAAAAAAAyDANBgkqhkiG
...
# gjcCARUwIwYJKoZIhvcNAQkEMRYEFCZOgzyODIN+oiBNYvLU7K/M4MkmMF4GCisG
...
# SIb3DQEBAQUABIIBAAnsC3ufGHNRwkj2nbMEQCdHkkRLEZ3ik8LCnVjEAsZd/P7v
# nhvu2ayk/SmVaSFa37P8JS+pUI7gGjE+CQ8cuVkF71NyubX9dQF5cURx+7lqaNvT
# LAcB4aKD9v4eIh9XDE8LgzpzK607WrCFz8nQuOJeNy0O2mLiKyfIb+trtK9GY0Uq
# C3zexZ1wYlOAs8IF3Of8axxJtn1LfU6nqLijZeK2v08XXtMkwF+HHcipYH5Ha5Ue
# AhDDvhUQX1FdB2tCeOiKpEF4dpfFPq/6uNlcp2EebvWMYKnAmxAl0hmFIuEVznxw
# 8hXH7auZucNFnr0mLmkJBt28PHXH/bYr1swBOnyhggIoMIICJAYJKoZIhvcNAQkG
...
# BBSspNdt93TpMWzlekL1b1ppab1XQzANBgkqhkiG9w0BAQUFAASCAQB7jQifQOHR
# byKiCE/TjpfKyl+2+Vt7Fl/r5GZMlFOokGYtc+PU9FuRULsMFAmfUNsO46IsoNwS
# GnG9aoEs+XC8dniX5X7X9O82zP6HZRxriHBSjtneuT4exZU+m6EDiGpv6HSx9uJu
# h+V3m/WonbNzpTcOVLxTIpVuv4n3E/0Ta5ipyUA2JkzHb4tVRrUu27uz6JhTbuhX
# LyGCp7fzMX+c71vvLN+pUHEo222zNd5YXj1s3Cz5CDMSlVAtuWF/WlCWPOVAUh+U
# gUT/jfnXsrN7eiGet/P8cnHbm56ozCrnmKZNHw4ycqugYlEfXsidDJbc42XQVjms
# rWTU6y+QrAAX
