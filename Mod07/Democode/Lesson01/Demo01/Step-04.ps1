...
function Get-ArchitectureInfo {
    ...
    PROCESS {
        foreach ($computer in $computername) {
            ...
            Write-Debug "Finished querying $computer"

            $properties = @{'ComputerName'=$Computer;
                            'OSArchitecture'=[int]($os.osarchitecture -replace '-bit','');
...
# Notice that debug output is suppressed because we
# did not use -Debug
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU5kS7UlJU+O8IXG/WchHGWVgg
# yLGgghWCMIIEwzCCA6ugAwIBAgITMwAAAEyh6E3MtHR7OwAAAAAATDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFCLt
# Djyc7kqy5BkWgKdBSWrniY37MF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBAFZ2Ur5uy7pRcjlc
# ZglTXAB2vMeUQlt+skDsY0C7JMfDY82fPRWIZSOUkWnnVxkJ6FoUNe1qSXDUHF+L
# E9CAEGdY4zKJ7IeG3TznYNy7TMDjc4rUMids/rKJeqBFNOT9f/FYS/P97ajU4plt
# j6C5kt7NQNFZAO6FwYWbzStCLcGAdC20DaWpUV5L3xDKG2JaS0SiiaX8zhP/cLme
# U0zuStoUrf7Krz1lrulAnYF+6aEPUSgq8RqiRgEWmmUqinhmMdCwqsFyInQhCphY
# vr6SLQ/pCqkbPT8IA3laUtvP5p5t2qHRfvR3by9W1tdd7xDjakeMwijasoRq3DP9
# lZ1gRImhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MjcwODQzNDNaMCMGCSqGSIb3DQEJBDEWBBRFwjS5W+2UjDvVw41mYwC+3Nc1ojAN
# BgkqhkiG9w0BAQUFAASCAQA+RtsfYwFH5lWuW1MCZXj3sHXqxrGvZOaACggKis4+
# XzRN+Xw70BgTBN6qtwrIaHwFAmg5Dykq0PrPzPXySLYdFk/6Y9Ry1BYS6TaVOQ82
# lNtM+rKhu7EPor+2LGIHJJdiC1Jf2YpNvUCV7eqV/2caJ7nh93LRZvi3LlcXGyra
# nKkIUeIeu4w4oWSrW75VXVwEewILt3MAPryahDHwMomKy6Af6aqEbA4MkyWSp+Gv
# YULZmi72kbUo7zeYUsipE/Fi+22AuiclcvPQmCSJSwuIwx+QkhlUHCQX5EI2/Ovo
# nuooiHOLCNFeXBODmc2a+UG0HvfUMwSm7eK+XadWMfAM
