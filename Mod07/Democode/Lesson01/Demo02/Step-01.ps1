# You must save this as C:\DebugDemo.ps1 so that the demo
...
Set-PSBreakpoint -Script C:\DebugDemo.ps1 -Line 18

# Also set a breakpoint that outputs data to a debugging file
# each time $properties is written to
Set-PSBreakpoint -Script C:\DebugDemo.ps1 -Variable properties -Mode Write -Action { $properties | Out-File c:\debug.txt -append }

# This will run the command
Get-ArchitectureInfo -ComputerName LON-DC1,LON-SVR1 |
Where-Object { $_.ProcArchitecture -eq $_.OSArchitecture } |
Select-Object -Property ComputerName

# Check the contents of C:\Debug.txt
# SIG # Begin signature block
# MIIavQYJKoZIhvcNAQcCoIIarjCCGqoCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU2CZA7y4e/wuraZRIGa9ac7yA
# I0OgghWCMIIEwzCCA6ugAwIBAgITMwAAAEyh6E3MtHR7OwAAAAAATDANBgkqhkiG
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFDcY
# nnJLnWxEvLfknROOn9/3/fhVMF4GCisGAQQBgjcCAQwxUDBOoCaAJABNAGkAYwBy
# AG8AcwBvAGYAdAAgAEwAZQBhAHIAbgBpAG4AZ6EkgCJodHRwOi8vd3d3Lm1pY3Jv
# c29mdC5jb20vbGVhcm5pbmcgMA0GCSqGSIb3DQEBAQUABIIBAI6kIS5E4FQI0uWN
# ddBA6ph9f2aeFjoDCgKAtHqSZx24hIiT3H0c99l5DWJGf9Q0mC/HnGhthKrq+AFa
# gCOH4Q/C11Abd/Jt+bCEcsu3AbiwhBKCzkIW3amVi7GPvd1QH9jQTNYfGtdY/gpT
# FcNn2OqOJl+O9A7j5Zri/gVx426jAr3kNq2rqiHmzB3TPW9Soj1rYM4Apkxzr/F5
# TGl1OYVCa5sMjCI56L0/ME7y5N82hIoapqmeub2mpelrkGAcfNwKBqlNwhejTHrX
# PE7/EPkR2EsSSz8mP0YpY0HeQa20hV4+NFuPRvX7I8uqbyR7nxeFuSwISvojAm7d
# zmGYzfyhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkGA1UE
...
# MjcwODQzNDNaMCMGCSqGSIb3DQEJBDEWBBSAdgYJ+Jm7AVqPSsA3cuwB22x7MjAN
# BgkqhkiG9w0BAQUFAASCAQATVyipPvZtl0Pv8Bek5lGmD2IEqXQ0RuH+M4EgaMyu
# tWLfiUgZN0vZzJ5jC7b7P/ggOhnY3AGbNOq2seIO9iyWIaPVFJaxhgLceqoFX9TT
# mLJKJr6U1mXlnMO8jKz50562WElAxSHFox5NG5NwQI6+Qg0zxTbrfAvmA30eXXGY
# RBRhhsSxyuAJXkrnT8jK6M0JuGxcSrl/89kgJet4IzajrsogOFk3JJPAw2foM3Yj
# faBsUSd31l+oUdAZCC10Ls5bGF7EXhgPHooGi65Hgc8reEAdbc4eiwtpckAublCW
# BF2JMn4sQL1Doar72THIQpT9cyjPVO+jQNPyfSIfoO4V
