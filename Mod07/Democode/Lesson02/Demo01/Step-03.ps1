# We're getting an "invalid query" error on line 15 (now line 18)
# That suggests either $service doesn't contain what we thought
# or that a Win32_Process doesn't look like we thought 
    ...
    PROCESS {
        foreach($computer in $computername){
            ...
            foreach($service in $services) {
                ...
                Write-Debug "Querying process for $($service.name), process ID $($service.processid)"

                $process = Get-WmiObject -Class win32_process -ComputerName $computer -Filter "id=$($service.processid)"
...
Get-ServiceProcess -computername localhost -Debug
# SIG # Begin signature block
# MIIatQYJKoZIhvcNAQcCoIIapjCCGqICAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUxEgNaxdhTKDsG2CqSFK9g15j
# VQygghV6MIIEuzCCA6OgAwIBAgITMwAAAFnWc81RjvAixQAAAAAAWTANBgkqhkiG
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBS4F+iLCVZN17bL
# C139oDYYfKqOSjBeBgorBgEEAYI3AgEMMVAwTqAmgCQATQBpAGMAcgBvAHMAbwBm
# AHQAIABMAGUAYQByAG4AaQBuAGehJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
# L2xlYXJuaW5nIDANBgkqhkiG9w0BAQEFAASCAQBE+fm7I4mRzqNkdFaxh1YT3elW
# ZL2nuUaxnVrO1jDb8d7b2M41+MC6Ml6mLF+TYrPKUGICXM+W0GlnJT9AC/dUffZH
# AoSiws8Un7Ttaqufc0hCHi7WmLpt0TBdsbfRJodxeBCS+2LHLScb/TxBX+/0xGZs
# aaQx6mnpSYXc9l7OaI8n2Ek/amgznjwoC18+ywF3DT7hSMWV582awlWgQmzstSIy
# P91QRtNJUlC2zsNb2LCb9pIe6MpYmBqrlA75biTgOaSFojeQtAUiVVlj7aImf1q1
# DGMHSaR6JBGCD1O99xIhiPd+LRkYuu6stCZySPRzZ3OqjWuO+OwA/Ep6TRK8oYIC
...
# hvcNAQkDMQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMTQxMDI3MDg0MzQ0
# WjAjBgkqhkiG9w0BCQQxFgQUDW+q5S2SKAuGfjbN8IaGxhbSdncwDQYJKoZIhvcN
# AQEFBQAEggEAOducEQtGeL2gLPWIDO75SoPmcjcUIvHS5OjdagkPvHMbUcQNrVAM
# BQ/WggOLPqAwv8acRtdZZ+enTcbQskGJUArJlpuwkxSlEfW4rt9rpnQUQ5qyX9tl
# Y3jc6N1XPl3BWjsGNW6hp9tLp44I3QQuLk8Mtm4x4D/XsLX8Z1kOShbl5hFTLbdm
# BagrdMmP1xkr3WdOFLM2VxQJn6Ye747D6DNLz33MPi63cmXigKi2iS3bXaEVQwei
# fYWWyexxnJE/X9lstgNQx8Q0ugW81WpSTejeQMoeiezvc3q3t2xpyIUqfdpqCO3f
# BaPcjSrAq4iTmKkH+ryi2Gv5Ey/iSA3AZg==
