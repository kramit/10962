# We've added a check for process ID 0 on services that are
# not running
    ...
    PROCESS {
        foreach($computer in $computername){
            ...
            foreach($service in $services) {
                ...
                if ($process.processid -eq 0 -and $service.state -ne 'Running') {
                    $procname = '(Not started)'
                } else {
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUZiCWtYnz4PjDtYBBhDgEDRwe
# 2WWgghV6MIIEuzCCA6OgAwIBAgITMwAAAFrtL/TkIJk/OgAAAAAAWjANBgkqhkiG
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBSK5AqC/YxXiFyw
# DkB6YSwWyCDB/TBeBgorBgEEAYI3AgEMMVAwTqAmgCQATQBpAGMAcgBvAHMAbwBm
# AHQAIABMAGUAYQByAG4AaQBuAGehJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
# L2xlYXJuaW5nIDANBgkqhkiG9w0BAQEFAASCAQBcBbVwhw5ajazwWhUOg2F3t4GH
# E5V8YQUd+pG/1qH5WOW6zUSKxdxE1xYcufVwZ3inSNNEI2KsvVITD50HMW7thdAX
# tBLZ1U6+9fLlj84XF2LJb6UjMtXvbABu2ORF7GmDD5d3Ws8v1er3X978lbORQ++a
# v287GUqceJT1K/S8LIyBjssqRZ1/hncElJHy4Oeq8bBJrFeAnvvvEWzz9V4O+ykE
# V4Vp9Isc8QH8b8lR0OH/Y0gFKpq9RUjHU5l0icIVt/iacXdlKklABL+N5BIAvf63
# g4laQz3Bx/IRxGeM/v1D2jyzUhq+OjrDfs1eOg8fyeeU6gJk2W+ray1U0+IYoYIC
...
# WjAjBgkqhkiG9w0BCQQxFgQU2AHMhtKHkaDKgNgcdhRW/9EUfKIwDQYJKoZIhvcN
# AQEFBQAEggEAfxMtudDOTsVqEE3VMqBq1+T/CqSFx/PTnVTcpxA9WGZDr3UTpY5X
# zjvsnyKvnGrO7okCTjLag4Vs3ui9+Vzjcz53nAJdrvmtQD8oJUDiipHXmTzaBgh7
# cVlYyjkRjK4/EFkkBavmmEeB9LtgVzTXMXDjV+4Qr3dviKpGAv3l8yAUSSWQBeoB
# HLi18mLA7CqHgLs9iNNsk2Bu4qse72sxwnCG/t7sayp8zWrqK6A9k79xQmXGuQId
# tkYqjwz3z5AqVeTtUfFFqIGThG0nY8+UTc6MA0XFpIKwNVihWKcJEz4L+rtUqY8j
# M1vy939XFVx1RPH7u23++n2CVPecnKER1A==
