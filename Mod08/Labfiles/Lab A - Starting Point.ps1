Function Restart-AdatumComputer {
    Param (
        [string[]]$ComputerName1,
        [string[]]$ComputerName2
    )
    ForEach ($computer1 in $ComputerName1) {
        $os1 = Get-CimInstance -ClassName Win32_OperatingSystem -Computername $computer1 -Property LastBootUptime,CSName
        Write-Output -InputObject "$($os1.CSName) last boot uptime is $($os1.LastBootUpTime)"
    }
    ForEach ($computer2 in $ComputerName2) {
        $os2 = Get-CimInstance -ClassName Win32_OperatingSystem -Computername $computer2 -Property LastBootUptime,CSName
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUVVNChI/1wvUfRDeHfE/k2DBe
# +4egghhlMIIEwzCCA6ugAwIBAgITMwAAALWsfW2HayYRRwAAAAAAtTANBgkqhkiG
...
# gjcCARUwIwYJKoZIhvcNAQkEMRYEFArWN+zYUlfbmsipVU+N1ytxQT+uMF4GCisG
...
# SIb3DQEBAQUABIIBAGh4cNvxaqvhr86pAx7NGXuOsUgWEJxZHCnAFqfD3gNVMw/R
# 7oNFR9eIuQuQ1vSELFXpukC9fJHXVl4SxN380vUImJNL7GWliMN2wwMPLQbGgJJy
# 6UHc0vBpvklPaCNOjVQ9CRMNHPUMTG8btexQ3/BgdwTYZU/j2u9HGjSWfXisD5qz
# vmB5fjJWgNQnw4/nKDaGiXwaG2nZjyO8lWPu7Bmjj7rMhSUN37nh0APfeZKWQ/Zk
# vtqPl1PujbZUAIlhFaVWhlJOUPv1SAEVxbSlAAZNtCfPAyquSdR1RirMSjALunqC
# sDAQrXSALEi+47YlOGYYVOYJAqvgZ2c62adYwzChggIoMIICJAYJKoZIhvcNAQkG
...
# BBSZ5Wf6QN5jUlPoKS5f2lcHrkZgmzANBgkqhkiG9w0BAQUFAASCAQAI10U3ZReh
# +aA+Ys7jj9uDcaWQGUrBm39MjPiCH/HliMAVec9yVb14M/FGk/xvqLI62pysV3ZS
# DWTGSy5poDtnbWHZWOPfWqjOMvF8+IAD9YNwsXfDTDli0GWAThg8DvL0yhsUJBvO
# PaPXh7zip6MZfds+jC56U/epDrWt1w75F0KC/Kb027RXSFxT1iCx4qfE69GN+dhK
# YLnAI3wv7Ff9fePuum4zDuCB0fNC35OU9FP0792LukNqHqrLkNKxC4AHJjUHAiZu
# HNoVvjv/ep75CtEcZAANp5MR/zPbkE+5Y/U52PVxbXAXDDOQBO8wAP/H0kcMK7Kf
# vMrMnfEs2Oo+
