Workflow Restart-AdatumComputer {
    ...
    Foreach ($computer1 in $ComputerName1) {
        ...
        Write-Output -InputObject "$($os1.CSName) last last boot uptime is $($os1.LastBootUpTime)"
    }
    Foreach ($computer2 in $ComputerName2) {
        ...
        Write-Output -InputObject "$($os2.CSName) last last boot uptime is $($os2.LastBootUpTime)"
    }            
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUtrWjxZKlbiqE7YZmvPjpB/4f
# BtWgghhlMIIEwzCCA6ugAwIBAgITMwAAALWsfW2HayYRRwAAAAAAtTANBgkqhkiG
...
# gjcCARUwIwYJKoZIhvcNAQkEMRYEFMohKRMoySbPPWoGCVD9N7vqy2g9MF4GCisG
...
# SIb3DQEBAQUABIIBAI5CgQviWTQQphrerRSj9MTmLoiBATv8AeJkSkkGiIPTPAyW
# BiH2nQ7eiBI6J3zAQL78tulysfOpJPtEN/FDvcGdzN7BOjoJls6H1OX/inWJBLBE
# XgaWh/Zu/XfyWHfFDz7qKs4/krIeP4rrFiEyRvOc5TuzaibXAnfhuJe9c7J67FZu
# 0zKylXtywPq0bH2YCI7D/a/uFs9yxITwYlpJ92HvqV1klmSCA7JgFZ6Iemk98S3i
# V8cJAGIv5fGR+2jdSxntMXuiJcINh0VjT9midywOM4miqgojAPzUHtF8miR/g+Zu
# CUtny53F12jzn7AIucoqdXpdzTWx1hx09ZQ2IMahggIoMIICJAYJKoZIhvcNAQkG
...
# BBSOZ4btmpQB3Rn6aDaIfCv/6gUdojANBgkqhkiG9w0BAQUFAASCAQA1UQ/oRHxG
# u2OxM/+6U3aSBYMUoZavyhEeNBSIdadBc9ztfi/ghtQALbo60ISEPMuXle2tSR66
# alHGAvcGO0bdZO06OyhvbuChxguwaijK0K2sPReY43jWWWIE9kuN9zi7MKTNVkZN
# EvYfCruGje7I0QDt0ElWak4pAAUMWJEH2fYZOrhwl9TDu7hdjVTD+CJYVNJHFzie
# 08Oee7xOV5gspvDBaDlym2UGqbD9uODVUJgs3T3u9Vmf7CWrHhp9HWPOm6NLgdhS
# aQrSJr9/HqkdT4izLq0Gt0xzmWFcm1ayOr42uR9cKsnLbl/7MSBL3P1IHR15EaeQ
# AfAndAdkZWfH
